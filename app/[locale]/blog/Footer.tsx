    ...
    <footer id="footer" style={{ backgroundColor: "#646464" }}>
      ...
      <div className="footercontainer">
        <p style={{ fontSize: 16, margin: 0, color: "#fff" }}>
          <strong style={{ color: "#fff" }}>{menus[8].title}</strong> +381 24 764 270
          <br />
          <strong style={{ color: "#fff" }}>{menus[9].title}</strong> 063 7 150 100
          <br />
          <strong style={{ color: "#fff" }}>Email:</strong> vetservis@gmail.com
          <br />
